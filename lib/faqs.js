...
export const FAQS = [
  ...
  {
    // Merged from the retired /process page. Only the two questions that were
    // not already answered above came across — "who will be working on my
    // project", "what happens in the first consultation" and "do you work on
    // offices and shops" were all near-duplicates of existing entries, and a
    // FAQ that asks the same thing twice in different words is worse than a
    // shorter one.
