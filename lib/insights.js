...
export const INSIGHTS = [
  ...
  {
    slug: "modular-vs-carpenter-kitchen-kolkata",
    title: "Modular kitchen vs. carpenter-built: the real trade-offs in Kolkata",
    description:
      "Construction control, materials, hardware, edge finishing, maintenance, site conditions and repairability — the honest differences between a modular kitchen and a carpenter-built one, not a verdict in either direction.",
    excerpt:
      "“Which is better” is the wrong question. The right one is which set of trade-offs suits your kitchen, your site, and how you actually use the room.",
    owningService: { href: "/services/modular-kitchen", label: "Modular kitchen design" },
    readingMinutes: 8,
    published: "2026-09-02",
  },
  {
    slug: "how-to-read-an-interior-design-quotation",
    title: "What an interior design quotation should actually itemise",
    description:
      "How to read and compare interior design quotations line by line — scope, materials, hardware, labour, exclusions, assumptions and payment stages — so a lower number isn't mistaken for a better one.",
    excerpt:
      "Two quotations for the same flat can be pages apart in what they actually include. This is how to find out which one, if either, is complete.",
    owningService: { href: "/services/residential-interior-design", label: "Residential interior design" },
    readingMinutes: 9,
    published: "2026-09-02",
  },
  {
    slug: "old-vs-new-build-kolkata-flats",
    title: "Old vs. new-build Kolkata flats: what changes about the interior design brief",
    description:
      "Why a bare-shell new-build handover and an occupied older Kolkata flat start from a genuinely different brief — structure, services, moisture history, access and sequencing, before design work even begins.",
    excerpt:
      "The same three-bedroom layout means two different projects depending on whether the flat is a bare shell or a home someone has lived in for twenty years.",
    owningService: { href: "/services/home-renovation", label: "Home renovation" },
    readingMinutes: 7,
    published: "2026-09-02",
  },
