...
// The CRM is a separate application (see the migration report for the
// portal.avayaudyog.com cutover plan). Until that cutover happens, set
// NEXT_PUBLIC_PORTAL_URL to wherever the CRM is actually reachable today.
const PORTAL_URL = process.env.NEXT_PUBLIC_PORTAL_URL || "https://portal.avayaudyog.com/";
